                ...
                <div class="contact-form-card">
                    ...
                    <form id="contactEstimateForm">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <div class="cf-field">
                                    <input type="text" name="full_name" class="cf-input" placeholder=" " required>
                                    <label>Full Name *</label>
                                    <span class="text-danger small error-msg" id="full_name_error" style="position:absolute; bottom:-18px; left:0;"></span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cf-field">
                                    <input type="tel" name="phone" class="cf-input" placeholder=" " required>
                                    <label>Phone Number *</label>
                                    <span class="text-danger small error-msg" id="phone_error" style="position:absolute; bottom:-18px; left:0;"></span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cf-field">
                                    <input type="email" name="email" class="cf-input" placeholder=" ">
                                    <label>Email Address</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="cf-field">
                                    <input type="text" name="address" class="cf-input" placeholder=" " required>
                                    <label>Property Address *</label>
                                    <span class="text-danger small error-msg" id="address_error" style="position:absolute; bottom:-18px; left:0;"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="cf-field">
                                    <select name="service" class="cf-input cf-select" required>
                                    ...
                                    <span class="text-danger small error-msg" id="service_error" style="position:absolute; bottom:-18px; left:0;"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="cf-field">
                                    <textarea name="message" class="cf-input cf-textarea" rows="4" placeholder=" "></textarea>
                                    <label>Project Details</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn-cf-submit" id="contactSubmitBtn">
